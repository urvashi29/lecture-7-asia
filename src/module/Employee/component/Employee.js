...
import { onAddEmployee } from '../../actions';
...
class Employee extends Component {
    ...
    render() {
        const { employee, modal } = this.props;
        return (
            <>
...
const mapDisptchToProps = dispatch => {
    return {
        onAddItem: (emp) => dispatch(onAddEmployee(emp)),
        onOpenModal: (val) => dispatch(onModal(val))
    }
}
